...
# GET USER PROFILE
# ============================================================================
def get_user_profile_logic(
    current_user: User
):
    """
    Get current user's profile information logic
    """
    return {
        "id": current_user.id,
...
# UPDATE USER PROFILE
# ============================================================================
def update_user_profile_logic(
    profile_data,
    db: Session,
    current_user: User
):
    """
    Update user's profile information logic
    """
...
# ============================================================================
async def upload_profile_picture_logic(
    file: UploadFile,
    db: Session,
    current_user: User
):
    """
    Upload user profile picture logic
    """
